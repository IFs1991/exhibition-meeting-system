...
exports.ExhibitionModule = ExhibitionModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([exhibition_entity_1.Exhibition])],
        controllers: [exhibition_controller_1.ExhibitionController],
        providers: [exhibition_service_1.ExhibitionService],
        exports: [exhibition_service_1.ExhibitionService],
    })
], ExhibitionModule);
