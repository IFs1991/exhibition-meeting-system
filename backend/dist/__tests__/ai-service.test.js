...
describe('AiService', () => {
    ...
    describe('generateMeetingPurpose', () => {
        ...
        it('should include exhibition name in suggestions when provided', async () => {
            ...
            const hasSuggestionWithExhibitionName = result.some(suggestion => suggestion.includes(exhibitionInfo.name));
        ...
        it('should include industry-specific suggestions when client info is provided', async () => {
            ...
            const hasITSuggestion = result.some(suggestion => suggestion.includes('IT技術') || suggestion.includes('デジタル'));
        ...
        it('should include keywords in suggestions when provided', async () => {
            ...
            const hasSuggestionWithKeywords = result.some(suggestion => keywords.some(keyword => suggestion.includes(keyword)));
